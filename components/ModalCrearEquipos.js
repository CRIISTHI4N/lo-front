...
export default function ModalCrearEquipos() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post(`${process.env.NEXT_PUBLIC_URI}/api/equipos-obra/ingresar`, {
                nombreEquipo
            })
    ...
    return (
        <>
            <div className="py-10 px-5 border-b border-gray-300">
                ...
                <span className="block text-center text-2xl">Agregrar Equipo</span>
            </div>
